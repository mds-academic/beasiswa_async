"""
Update Code.gs with Payload v5
Embeds 18-step SD curriculum, 36-step SMP, 36-step SMA, 18-step ops-result-sd, and 12 Changelog records.
"""
import json
import os

def update_code_gs():
    base_dir = "projects/uob-async-lms"
    if not os.path.exists(base_dir):
        base_dir = "."

    # 1. Load payload v5
    payload_path = f"{base_dir}/subprojects/02-curriculum-sequencing/output/curriculum_sheet_payload_v5.json"
...
'''
    ...
    # Build seed evaluations for SD (18 steps)
...
'''
    ...
    # Read base Code.gs
    code_gs_path = f"{base_dir}/subprojects/01-lms-platform/apps-script/Code.gs"
    ...
    print(f"✅ Generated updated Code.gs v5 with 18-step SD curriculum!")
