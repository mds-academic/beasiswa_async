...
def build_curriculum_dataset_v3():
    ...
    changelog_rows = [
        ...
        [
            ...
            "Anomali timestamp: bookmark video berada di luar batas durasi total (misal 12:00 saat video hanya 11:24) dan trigger kuis pop-up berada di luar rentang aktif video.",
