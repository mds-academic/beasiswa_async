...
modules=[
 {'id':'up-mod-00','order':0,'title':'Modul 0: Kenalan dengan Scratch','description':'Satu-satunya materi bridge untuk mengenal platform Scratch sebelum mulai tutorial project.','steps':[bridge_step(None,'bridge-sd-00','Materi Jembatan 00 · Kenalan Scratch')]},
 {'id':'up-mod-01','order':1,'title':'Modul 1: About Me — Perkenalan Interaktif','description':'Project pertama: membuat karakter dan perkenalan interaktif dari desain hingga animasi.','steps':[video_step(f'up-about-{i+1}',t,'Video About Me · Tutorial', 'about-me') for i,(v,t) in enumerate(playlists['about-me'])]},
 {'id':'up-mod-02','order':2,'title':'Modul 2: Racing Car — Logika Game','description':'Project kedua: membuat game balap dengan input keyboard, gerak, collision, dan aturan menang.','steps':[video_step(f'up-racing-{i+1}',t,'Video Racing Car · Tutorial', 'racing-car') for i,(v,t) in enumerate(playlists['racing-car'])]},
 {'id':'up-mod-03','order':3,'title':'Modul 3: Increase Your Earnings — Capstone','description':'Project ketiga: mengikuti starter project integratif dengan pilihan aktivitas, credit, scene, clone, dan ending.','steps':[video_step(f'up-earning-{i+1}',t,'Video Increase Your Earnings · Capstone', 'increase-earning') for i,(v,t) in enumerate(playlists['increase-earning'])]}
]
