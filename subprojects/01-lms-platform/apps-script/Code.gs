...
function setupResultTrackingSheets() {
  ...
  const configs = [
    {
      ...
      stepHeaders: ["bridge-sd-00 [Skor & Jawaban]", "up-about-1 [Skor & Jawaban]", "up-about-2 [Skor & Jawaban]", "up-about-3 [Skor & Jawaban]", "up-about-4 [Skor & Jawaban]", "up-about-5 [Skor & Jawaban]", "up-about-6 [Skor & Jawaban]", "up-about-7 [Skor & Jawaban]", "up-racing-1 [Skor & Jawaban]", "up-racing-2 [Skor & Jawaban]", "up-racing-3 [Skor & Jawaban]", "up-racing-4 [Skor & Jawaban]", "up-racing-5 [Skor & Jawaban]", "up-racing-6 [Skor & Jawaban]", "up-earning-1 [Skor & Jawaban]", "up-earning-2 [Skor & Jawaban]", "up-earning-3 [Skor & Jawaban]", "up-earning-4 [Skor & Jawaban]"],
      seedData: [
        [
          new Date().toISOString(),
  ...
  return {
    success: true,
    message: "Tab ops-result-sd (18 steps), ops-result-smp (36 steps), dan ops-result-sma (36 steps) berhasil diinisialisasi!"
  };
}
...
function populateCurriculumSheets() {
  ...
  return { 
    success: true, 
    message: "Tab materi-sd (18), materi-smp (36), materi-sma (36) berhasil diperbarui!", 
...
function populateChangelogSheet() {
  ...
  return {
    success: true,
    message: "Tab Changelog & Audit Log berhasil dibuat dengan 12 catatan perbaikan resmi!",
