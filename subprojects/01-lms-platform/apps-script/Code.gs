...
function populateCurriculumSheets() {
  ...
  return { success: true, message: "Tab materi-sd, materi-smp, materi-sma berhasil diperbarui dengan Pop-up Quiz dan Mini Project!", totalSD: payload.sd.length, totalSMP: payload.smp.length, totalSMA: payload.sma.length };
}
